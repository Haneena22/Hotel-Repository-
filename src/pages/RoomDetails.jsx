...
const RoomDetails = () => {
  ...
  return (
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-2">
          ...
          <p className="text-s font-inter py-1.5 px-3 text-white bg-orange-500 rounded-full">
            20% OFF
          </p>
        </div>
    ...
    justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-1
          ...
          >
            <div className="flex flex-col">
              ...
              <input
                ...
                className="w-full
                rounded border border-gray-300 p-3 py-2 mt-1.5 outline-none"
                required
              />
            </div>
